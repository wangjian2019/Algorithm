...
public class TreeAlgorithm{
	...
	private class BinaryTreeWithReference{
	 ...
	 * 
	 * 思路：从根节点开始找，如果当前节点比给出的x、y小，查当前节点右子树；
	 *       如果当前节点比给出的x,y大，查当前节点左子树；
	 ...
	 * 问题： 给定一个树的Root，求树的深度
	 * 
	 * 思路：递归思想，如果root==null,深度是0；
	 *                如果root没有子树，深度是1；
	 *                如果root只有一个左子树，深度是左子树深度+1;如果只有右子树，同理；
	 *                如果root有左右子树，深度是max(左子树，右子树)+1
	 */
